...
void myproject(
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<batch_normalization_20_scale_t, 24>(s4, "s4.txt");
        nnet::load_weights_from_txt<batch_normalization_20_bias_t, 24>(b4, "b4.txt");
        nnet::load_weights_from_txt<weight6_t, 288>(w6, "w6.txt");
        nnet::load_weights_from_txt<bias6_t, 12>(b6, "b6.txt");
        nnet::load_weights_from_txt<batch_normalization_21_scale_t, 12>(s8, "s8.txt");
        nnet::load_weights_from_txt<batch_normalization_21_bias_t, 12>(b8, "b8.txt");
    ...
    nnet::normalize<layer2_t, layer4_t, config4>(layer2_out, layer4_out, s4, b4); // batch_normalization_20

    layer5_t layer5_out[N_LAYER_2];
    #pragma HLS ARRAY_PARTITION variable=layer5_out complete dim=0
    nnet::relu<layer4_t, layer5_t, relu_config5>(layer4_out, layer5_out); // q_activation_20
    ...
    nnet::normalize<layer6_t, layer8_t, config8>(layer6_out, layer8_out, s8, b8); // batch_normalization_21

    layer9_t layer9_out[N_LAYER_6];
    #pragma HLS ARRAY_PARTITION variable=layer9_out complete dim=0
    nnet::relu<layer8_t, layer9_t, relu_config9>(layer8_out, layer9_out); // q_activation_21
