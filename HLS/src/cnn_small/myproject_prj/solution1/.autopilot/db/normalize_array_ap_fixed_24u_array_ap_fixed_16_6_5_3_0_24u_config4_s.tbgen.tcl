set moduleName normalize_array_ap_fixed_24u_array_ap_fixed_16_6_5_3_0_24u_config4_s
set isTopModule 0
...
set C_modelName {normalize<array<ap_fixed,24u>,array<ap_fixed<16,6,5,3,0>,24u>,config4>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer2_out int 384 regular {fifo 0 volatile }  }
	{ layer4_out int 384 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "layer2_out", "interface" : "fifo", "bitwidth" : 384, "direction" : "READONLY"} , 
 	{ "Name" : "layer4_out", "interface" : "fifo", "bitwidth" : 384, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer2_out_dout sc_in sc_lv 384 signal 0 } 
	...
	{ layer4_out_din sc_out sc_lv 384 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer2_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":384, "type": "signal", "bundle":{"name": "layer2_out", "role": "dout" }} , 
 	...
 	{ "name": "layer4_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":384, "type": "signal", "bundle":{"name": "layer4_out", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_16s_14ns_26_1_1_U12", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	layer2_out { ap_fifo {  { layer2_out_dout fifo_port_we 0 384 }  { layer2_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer2_out_fifo_cap fifo_update 0 2 }  { layer2_out_empty_n fifo_status 0 1 }  { layer2_out_read fifo_data 1 1 } } }
	layer4_out { ap_fifo {  { layer4_out_din fifo_port_we 1 384 }  { layer4_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer4_out_fifo_cap fifo_update 0 2 }  { layer4_out_full_n fifo_status 0 1 }  { layer4_out_write fifo_data 1 1 } } }
}
set moduleName normalize_array_ap_fixed_24u_array_ap_fixed_16_6_5_3_0_24u_config4_s
set isTopModule 0
set isCombinational 0
