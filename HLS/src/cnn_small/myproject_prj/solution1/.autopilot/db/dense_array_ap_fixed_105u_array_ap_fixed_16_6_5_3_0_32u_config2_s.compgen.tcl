...
set id 1
set name myproject_mux_105_7_16_1_1
...
set id 3
set name myproject_mux_32_5_15_1_1
set corename simcore_mux
set op mux
set stage_num 1
set din0_width 15
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler myproject_dense_array_ap_fixed_105u_array_ap_fixed_16_6_5_3_0_32u_config2_s_outidx_2_RObkb BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler myproject_dense_array_ap_fixed_105u_array_ap_fixed_16_6_5_3_0_32u_config2_s_w2_ROM_AUTOcud BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { y_timed_input_TVALID { I 1 bit } y_timed_input_TDATA { I 1680 vector } y_timed_input_TREADY { O 1 bit } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { layer2_out_din { O 512 vector } layer2_out_num_data_valid { I 2 vector } layer2_out_fifo_cap { I 2 vector } layer2_out_full_n { I 1 bit } layer2_out_write { O 1 bit } } \
} "
}
