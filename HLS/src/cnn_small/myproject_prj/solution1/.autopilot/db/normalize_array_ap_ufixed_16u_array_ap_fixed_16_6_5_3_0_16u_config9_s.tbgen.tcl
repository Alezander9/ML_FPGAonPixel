set moduleName normalize_array_ap_ufixed_16u_array_ap_fixed_16_6_5_3_0_16u_config9_s
set isTopModule 0
...
set C_modelName {normalize<array<ap_ufixed,16u>,array<ap_fixed<16,6,5,3,0>,16u>,config9>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer8_out int 240 regular {fifo 0 volatile }  }
	{ layer9_out int 256 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "layer8_out", "interface" : "fifo", "bitwidth" : 240, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer8_out_dout sc_in sc_lv 240 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer8_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":240, "type": "signal", "bundle":{"name": "layer8_out", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_15ns_14ns_28_1_1_U37", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	layer8_out { ap_fifo {  { layer8_out_dout fifo_port_we 0 240 }  { layer8_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer8_out_fifo_cap fifo_update 0 2 }  { layer8_out_empty_n fifo_status 0 1 }  { layer8_out_read fifo_data 1 1 } } }
