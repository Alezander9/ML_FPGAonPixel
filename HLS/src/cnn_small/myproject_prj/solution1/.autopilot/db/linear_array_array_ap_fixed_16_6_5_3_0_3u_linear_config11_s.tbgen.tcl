set moduleName linear_array_array_ap_fixed_16_6_5_3_0_3u_linear_config11_s
set isTopModule 0
...
set C_modelName {linear<array,array<ap_fixed<16,6,5,3,0>,3u>,linear_config11>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer15_out int 45 regular {fifo 0 volatile }  }
	{ layer11_out int 48 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "layer15_out", "interface" : "fifo", "bitwidth" : 45, "direction" : "READONLY"} , 
 	{ "Name" : "layer11_out", "interface" : "fifo", "bitwidth" : 48, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer15_out_dout sc_in sc_lv 45 signal 0 } 
	...
	{ layer11_out_din sc_out sc_lv 48 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer15_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":45, "type": "signal", "bundle":{"name": "layer15_out", "role": "dout" }} , 
 	...
 	{ "name": "layer11_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":48, "type": "signal", "bundle":{"name": "layer11_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	layer15_out { ap_fifo {  { layer15_out_dout fifo_port_we 0 45 }  { layer15_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer15_out_fifo_cap fifo_update 0 2 }  { layer15_out_empty_n fifo_status 0 1 }  { layer15_out_read fifo_data 1 1 } } }
	layer11_out { ap_fifo {  { layer11_out_din fifo_port_we 1 48 }  { layer11_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer11_out_fifo_cap fifo_update 0 2 }  { layer11_out_full_n fifo_status 0 1 }  { layer11_out_write fifo_data 1 1 } } }
}
