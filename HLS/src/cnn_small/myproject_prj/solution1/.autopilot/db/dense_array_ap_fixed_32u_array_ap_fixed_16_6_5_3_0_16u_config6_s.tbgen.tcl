set moduleName dense_array_ap_fixed_32u_array_ap_fixed_16_6_5_3_0_16u_config6_s
set isTopModule 0
...
set C_modelName {dense<array<ap_fixed,32u>,array<ap_fixed<16,6,5,3,0>,16u>,config6>}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_32_5_16_1_1_U22", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_16s_10s_24_1_1_U23", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_16_4_15_1_1_U24", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	layer6_out { ap_fifo {  { layer6_out_din fifo_port_we 1 256 }  { layer6_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer6_out_fifo_cap fifo_update 0 2 }  { layer6_out_full_n fifo_status 0 1 }  { layer6_out_write fifo_data 1 1 } } }
}
