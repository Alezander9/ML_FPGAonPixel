set moduleName linear_array_array_ap_fixed_16_6_5_3_0_16u_linear_config7_s
set isTopModule 0
...
set C_modelName {linear<array,array<ap_fixed<16,6,5,3,0>,16u>,linear_config7>}
...
set Spec2ImplPortList { 
	layer14_out { ap_fifo {  { layer14_out_dout fifo_port_we 0 240 }  { layer14_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer14_out_fifo_cap fifo_update 0 2 }  { layer14_out_empty_n fifo_status 0 1 }  { layer14_out_read fifo_data 1 1 } } }
	layer7_out { ap_fifo {  { layer7_out_din fifo_port_we 1 256 }  { layer7_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer7_out_fifo_cap fifo_update 0 2 }  { layer7_out_full_n fifo_status 0 1 }  { layer7_out_write fifo_data 1 1 } } }
}
set moduleName linear_array_array_ap_fixed_16_6_5_3_0_16u_linear_config7_s
set isTopModule 0
set isCombinational 0
