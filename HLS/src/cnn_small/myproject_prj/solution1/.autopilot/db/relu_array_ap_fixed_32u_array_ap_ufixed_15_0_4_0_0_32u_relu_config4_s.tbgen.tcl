set moduleName relu_array_ap_fixed_32u_array_ap_ufixed_15_0_4_0_0_32u_relu_config4_s
set isTopModule 0
...
set C_modelName {relu<array<ap_fixed,32u>,array<ap_ufixed<15,0,4,0,0>,32u>,relu_config4>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer3_out int 512 regular {fifo 0 volatile }  }
	{ layer4_out int 480 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "layer3_out", "interface" : "fifo", "bitwidth" : 512, "direction" : "READONLY"} , 
 	{ "Name" : "layer4_out", "interface" : "fifo", "bitwidth" : 480, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer4_out_din sc_out sc_lv 480 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer4_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":480, "type": "signal", "bundle":{"name": "layer4_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	layer4_out { ap_fifo {  { layer4_out_din fifo_port_we 1 480 }  { layer4_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer4_out_fifo_cap fifo_update 0 2 }  { layer4_out_full_n fifo_status 0 1 }  { layer4_out_write fifo_data 1 1 } } }
}
