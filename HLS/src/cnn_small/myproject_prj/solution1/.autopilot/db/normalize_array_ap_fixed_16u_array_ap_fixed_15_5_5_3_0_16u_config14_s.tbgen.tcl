set moduleName normalize_array_ap_fixed_16u_array_ap_fixed_15_5_5_3_0_16u_config14_s
set isTopModule 0
...
set C_modelName {normalize<array<ap_fixed,16u>,array<ap_fixed<15,5,5,3,0>,16u>,config14>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer6_out int 256 regular {fifo 0 volatile }  }
	{ layer14_out int 240 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "layer6_out", "interface" : "fifo", "bitwidth" : 256, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer6_out_dout sc_in sc_lv 256 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer6_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":256, "type": "signal", "bundle":{"name": "layer6_out", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	layer6_out { ap_fifo {  { layer6_out_dout fifo_port_we 0 256 }  { layer6_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer6_out_fifo_cap fifo_update 0 2 }  { layer6_out_empty_n fifo_status 0 1 }  { layer6_out_read fifo_data 1 1 } } }
	layer14_out { ap_fifo {  { layer14_out_din fifo_port_we 1 240 }  { layer14_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer14_out_fifo_cap fifo_update 0 2 }  { layer14_out_full_n fifo_status 0 1 }  { layer14_out_write fifo_data 1 1 } } }
}
