set moduleName relu_array_ap_fixed_24u_array_ap_ufixed_15_0_4_0_0_24u_relu_config5_s
set isTopModule 0
...
set C_modelName {relu<array<ap_fixed,24u>,array<ap_ufixed<15,0,4,0,0>,24u>,relu_config5>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer4_out int 384 regular {fifo 0 volatile }  }
	{ layer5_out int 360 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "layer4_out", "interface" : "fifo", "bitwidth" : 384, "direction" : "READONLY"} , 
 	{ "Name" : "layer5_out", "interface" : "fifo", "bitwidth" : 360, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer5_out_din sc_out sc_lv 360 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer5_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":360, "type": "signal", "bundle":{"name": "layer5_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	layer5_out { ap_fifo {  { layer5_out_din fifo_port_we 1 360 }  { layer5_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer5_out_fifo_cap fifo_update 0 2 }  { layer5_out_full_n fifo_status 0 1 }  { layer5_out_write fifo_data 1 1 } } }
}
set moduleName relu_array_ap_fixed_24u_array_ap_ufixed_15_0_4_0_0_24u_relu_config5_s
set isTopModule 0
set isCombinational 0
