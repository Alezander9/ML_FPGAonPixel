set moduleName normalize_array_ap_ufixed_32u_array_ap_fixed_16_6_5_3_0_32u_config5_s
set isTopModule 0
...
set C_modelName {normalize<array<ap_ufixed,32u>,array<ap_fixed<16,6,5,3,0>,32u>,config5>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer4_out int 480 regular {fifo 0 volatile }  }
	{ layer5_out int 512 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "layer4_out", "interface" : "fifo", "bitwidth" : 480, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer4_out_dout sc_in sc_lv 480 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer4_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":480, "type": "signal", "bundle":{"name": "layer4_out", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_15ns_17s_31_1_1_U18", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	layer4_out { ap_fifo {  { layer4_out_dout fifo_port_we 0 480 }  { layer4_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer4_out_fifo_cap fifo_update 0 2 }  { layer4_out_empty_n fifo_status 0 1 }  { layer4_out_read fifo_data 1 1 } } }
