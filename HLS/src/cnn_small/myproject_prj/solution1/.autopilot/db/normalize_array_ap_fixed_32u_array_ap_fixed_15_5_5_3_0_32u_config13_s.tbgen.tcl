set moduleName normalize_array_ap_fixed_32u_array_ap_fixed_15_5_5_3_0_32u_config13_s
set isTopModule 0
...
set C_modelName {normalize<array<ap_fixed,32u>,array<ap_fixed<15,5,5,3,0>,32u>,config13>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer2_out int 512 regular {fifo 0 volatile }  }
	{ layer13_out int 480 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "layer2_out", "interface" : "fifo", "bitwidth" : 512, "direction" : "READONLY"} , 
 	{ "Name" : "layer13_out", "interface" : "fifo", "bitwidth" : 480, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer2_out_dout sc_in sc_lv 512 signal 0 } 
	...
	{ layer13_out_din sc_out sc_lv 480 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer2_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "layer2_out", "role": "dout" }} , 
 	...
 	{ "name": "layer13_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":480, "type": "signal", "bundle":{"name": "layer13_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	layer2_out { ap_fifo {  { layer2_out_dout fifo_port_we 0 512 }  { layer2_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer2_out_fifo_cap fifo_update 0 2 }  { layer2_out_empty_n fifo_status 0 1 }  { layer2_out_read fifo_data 1 1 } } }
	layer13_out { ap_fifo {  { layer13_out_din fifo_port_we 1 480 }  { layer13_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer13_out_fifo_cap fifo_update 0 2 }  { layer13_out_full_n fifo_status 0 1 }  { layer13_out_write fifo_data 1 1 } } }
}
