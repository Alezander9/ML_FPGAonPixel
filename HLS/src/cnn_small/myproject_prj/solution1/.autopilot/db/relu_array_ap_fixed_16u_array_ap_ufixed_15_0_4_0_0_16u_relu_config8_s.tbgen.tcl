set moduleName relu_array_ap_fixed_16u_array_ap_ufixed_15_0_4_0_0_16u_relu_config8_s
set isTopModule 0
...
set C_modelName {relu<array<ap_fixed,16u>,array<ap_ufixed<15,0,4,0,0>,16u>,relu_config8>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer7_out int 256 regular {fifo 0 volatile }  }
	{ layer8_out int 240 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "layer7_out", "interface" : "fifo", "bitwidth" : 256, "direction" : "READONLY"} , 
 	{ "Name" : "layer8_out", "interface" : "fifo", "bitwidth" : 240, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer7_out_dout sc_in sc_lv 256 signal 0 } 
	...
	{ layer8_out_din sc_out sc_lv 240 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer7_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":256, "type": "signal", "bundle":{"name": "layer7_out", "role": "dout" }} , 
 	...
 	{ "name": "layer8_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":240, "type": "signal", "bundle":{"name": "layer8_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	layer7_out { ap_fifo {  { layer7_out_dout fifo_port_we 0 256 }  { layer7_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer7_out_fifo_cap fifo_update 0 2 }  { layer7_out_empty_n fifo_status 0 1 }  { layer7_out_read fifo_data 1 1 } } }
	layer8_out { ap_fifo {  { layer8_out_din fifo_port_we 1 240 }  { layer8_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer8_out_fifo_cap fifo_update 0 2 }  { layer8_out_full_n fifo_status 0 1 }  { layer8_out_write fifo_data 1 1 } } }
}
