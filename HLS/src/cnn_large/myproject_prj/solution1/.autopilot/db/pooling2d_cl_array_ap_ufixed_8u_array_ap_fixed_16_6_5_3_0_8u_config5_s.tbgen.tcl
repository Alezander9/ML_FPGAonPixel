set moduleName pooling2d_cl_array_ap_ufixed_8u_array_ap_fixed_16_6_5_3_0_8u_config5_s
set isTopModule 0
...
set C_modelName {pooling2d_cl<array<ap_ufixed,8u>,array<ap_fixed<16,6,5,3,0>,8u>,config5>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer4_out int 80 regular {fifo 0 volatile }  }
	{ layer5_out int 128 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "layer4_out", "interface" : "fifo", "bitwidth" : 80, "direction" : "READONLY"} , 
 	{ "Name" : "layer5_out", "interface" : "fifo", "bitwidth" : 128, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer4_out_dout sc_in sc_lv 80 signal 0 } 
	...
	{ layer5_out_din sc_out sc_lv 128 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer4_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":80, "type": "signal", "bundle":{"name": "layer4_out", "role": "dout" }} , 
 	...
 	{ "name": "layer5_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "layer5_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	layer4_out { ap_fifo {  { layer4_out_dout fifo_port_we 0 80 }  { layer4_out_num_data_valid fifo_status_num_data_valid 0 8 }  { layer4_out_fifo_cap fifo_update 0 8 }  { layer4_out_empty_n fifo_status 0 1 }  { layer4_out_read fifo_data 1 1 } } }
	layer5_out { ap_fifo {  { layer5_out_din fifo_port_we 1 128 }  { layer5_out_num_data_valid fifo_status_num_data_valid 0 6 }  { layer5_out_fifo_cap fifo_update 0 6 }  { layer5_out_full_n fifo_status 0 1 }  { layer5_out_write fifo_data 1 1 } } }
}
