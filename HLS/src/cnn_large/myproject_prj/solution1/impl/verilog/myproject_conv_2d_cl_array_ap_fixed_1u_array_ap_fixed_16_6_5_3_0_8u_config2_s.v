...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1_subdone) & (icmp_ln51_reg_150 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage0_11001_ignoreCallOp20) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'b0 == ap_block_pp0_stage1_11001_ignoreCallOp19) & (1'b1 == ap_CS_fsm_pp0_stage1)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_11001_ignoreCallOp20 = ((ap_done_reg == 1'b1) | ((ap_done_reg == 1'b1) & (ap_enable_reg_pp0_iter0 == 1'b1)));
end
...
always @ (*) begin
    ap_block_pp0_stage1_11001 = (((grp_compute_output_buffer_2d_array_array_ap_fixed_16_6_5_3_0_8u_config2_s_fu_80_layer2_out_blk_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((icmp_ln51_reg_150 == 1'd0) & (layer19_out_empty_n == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage1_11001_ignoreCallOp19 = ((icmp_ln51_reg_150 == 1'd0) & (layer19_out_empty_n == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage1_subdone = (((grp_compute_output_buffer_2d_array_array_ap_fixed_16_6_5_3_0_8u_config2_s_fu_80_layer2_out_blk_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((icmp_ln51_reg_150 == 1'd0) & (layer19_out_empty_n == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state2_pp0_stage1_iter0 = ((icmp_ln51_reg_150 == 1'd0) & (layer19_out_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state2_pp0_stage1_iter0_ignore_call5 = ((icmp_ln51_reg_150 == 1'd0) & (layer19_out_empty_n == 1'b0));
end
...
always @ (*) begin
    ap_block_state4_pp0_stage1_iter1 = (grp_compute_output_buffer_2d_array_array_ap_fixed_16_6_5_3_0_8u_config2_s_fu_80_layer2_out_blk_n == 1'b0);
end
