...
skl_model_path = '/u1/hjia625/conifer/CNN_best_quantized_pruned.h5'
# Load the model
...
hls_config['Model']['Precision'] = 'ap_fixed<32,10>'
...
data_file_path = './tb_input_features.dat'
out_file_path = './tb_output_predictions.dat'
