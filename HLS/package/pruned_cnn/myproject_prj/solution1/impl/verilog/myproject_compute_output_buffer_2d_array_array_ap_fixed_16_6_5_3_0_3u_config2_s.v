...
module myproject_compute_output_buffer_2d_array_array_ap_fixed_16_6_5_3_0_3u_config2_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] and_ln289_2_reg_352;
reg   [31:0] sX_3_load_reg_326;
wire   [0:0] icmp_ln289_fu_150_p2;
reg   [31:0] sY_3_load_reg_336;
reg   [31:0] pY_3_load_reg_342;
reg   [31:0] pX_3_load_reg_347;
wire   [0:0] and_ln289_2_fu_207_p2;
...
wire    tmp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_16_6_5_3_0_config2_mult_s_fu_119_ap_ready;
wire   [15:0] tmp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_16_6_5_3_0_config2_mult_s_fu_119_ap_return_0;
wire   [15:0] tmp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_16_6_5_3_0_config2_mult_s_fu_119_ap_return_1;
wire   [15:0] tmp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_16_6_5_3_0_config2_mult_s_fu_119_ap_return_2;
wire   [31:0] select_ln323_fu_305_p3;
reg   [31:0] ap_phi_mux_storemerge_phi_fu_84_p4;
reg    ap_predicate_op25_write_state2;
reg    ap_block_state2;
wire   [0:0] icmp_ln313_fu_241_p2;
wire   [0:0] icmp_ln317_fu_288_p2;
wire   [31:0] select_ln328_fu_258_p3;
wire   [31:0] add_ln317_fu_283_p2;
wire   [31:0] add_ln313_fu_236_p2;
reg   [31:0] grp_fu_141_p0;
wire   [30:0] tmp_7_fu_169_p4;
wire   [30:0] tmp_8_fu_185_p4;
wire   [0:0] icmp_ln289_5_fu_179_p2;
wire   [0:0] icmp_ln289_6_fu_195_p2;
wire   [0:0] and_ln289_fu_201_p2;
wire   [0:0] grp_fu_141_p2;
wire   [31:0] add_ln328_fu_253_p2;
wire   [31:0] add_ln323_fu_300_p2;
reg   [1:0] ap_NS_fsm;
...
myproject_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_16_6_5_3_0_config2_mult_s tmp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_16_6_5_3_0_config2_mult_s_fu_119(
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_131)) begin
        if ((icmp_ln313_fu_241_p2 == 1'd1)) begin
            pX_3 <= 32'd0;
        end else if ((icmp_ln313_fu_241_p2 == 1'd0)) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_192)) begin
        if ((icmp_ln317_fu_288_p2 == 1'd1)) begin
            pY_3 <= 32'd0;
        end else if ((icmp_ln317_fu_288_p2 == 1'd0)) begin
...
always @ (posedge ap_clk) begin
    if ((~((layer2_out_full_n == 1'b0) & (ap_predicate_op25_write_state2 == 1'b1)) & (1'b1 == ap_ce) & (1'b1 == ap_CS_fsm_state2) & (icmp_ln313_fu_241_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_ce) | ((layer2_out_full_n == 1'b0) & (ap_predicate_op25_write_state2 == 1'b1)))) begin
...
always @ (*) begin
    if ((((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)) | (~((layer2_out_full_n == 1'b0) & (ap_predicate_op25_write_state2 == 1'b1)) & (1'b1 == ap_ce) & (1'b1 == ap_CS_fsm_state2)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln313_fu_241_p2 == 1'd1))) begin
        if ((icmp_ln317_fu_288_p2 == 1'd1)) begin
...
always @ (*) begin
    if ((~((layer2_out_full_n == 1'b0) & (ap_predicate_op25_write_state2 == 1'b1)) & (1'b1 == ap_ce) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if (((1'd1 == and_ln289_2_reg_352) & (icmp_ln289_reg_331 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if ((~((layer2_out_full_n == 1'b0) & (ap_predicate_op25_write_state2 == 1'b1)) & (1'b1 == ap_ce) & (1'b1 == ap_CS_fsm_state2) & (ap_predicate_op25_write_state2 == 1'b1))) begin
...
assign add_ln313_fu_236_p2 = (pX_3_load_reg_347 + 32'd1);

assign add_ln317_fu_283_p2 = (pY_3_load_reg_342 + 32'd1);

assign add_ln323_fu_300_p2 = (sY_3_load_reg_336 + 32'd1);

assign add_ln328_fu_253_p2 = (sX_3_load_reg_326 + 32'd1);

assign and_ln289_2_fu_207_p2 = (grp_fu_141_p2 & and_ln289_fu_201_p2);

assign and_ln289_fu_201_p2 = (icmp_ln289_6_fu_195_p2 & icmp_ln289_5_fu_179_p2);
...
always @ (*) begin
    ap_block_state2 = ((layer2_out_full_n == 1'b0) & (ap_predicate_op25_write_state2 == 1'b1));
end

always @ (*) begin
    ap_condition_131 = (~((layer2_out_full_n == 1'b0) & (ap_predicate_op25_write_state2 == 1'b1)) & (1'b1 == ap_ce) & (1'b1 == ap_CS_fsm_state2));
end

always @ (*) begin
    ap_condition_192 = (~((layer2_out_full_n == 1'b0) & (ap_predicate_op25_write_state2 == 1'b1)) & (1'b1 == ap_ce) & (1'b1 == ap_CS_fsm_state2) & (icmp_ln313_fu_241_p2 == 1'd1));
end

always @ (*) begin
    ap_predicate_op25_write_state2 = ((1'd1 == and_ln289_2_reg_352) & (icmp_ln289_reg_331 == 1'd1));
end

assign grp_fu_141_p2 = ((grp_fu_141_p0 == 32'd2) ? 1'b1 : 1'b0);

assign icmp_ln289_5_fu_179_p2 = (($signed(tmp_7_fu_169_p4) > $signed(31'd0)) ? 1'b1 : 1'b0);

assign icmp_ln289_6_fu_195_p2 = (($signed(tmp_8_fu_185_p4) > $signed(31'd0)) ? 1'b1 : 1'b0);

assign icmp_ln289_fu_150_p2 = ((sX_3 == 32'd2) ? 1'b1 : 1'b0);

assign icmp_ln313_fu_241_p2 = ((add_ln313_fu_236_p2 == 32'd15) ? 1'b1 : 1'b0);

assign icmp_ln317_fu_288_p2 = ((add_ln317_fu_283_p2 == 32'd10) ? 1'b1 : 1'b0);

assign layer2_out_din = {{{tmp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_16_6_5_3_0_config2_mult_s_fu_119_ap_return_2}, {tmp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_16_6_5_3_0_config2_mult_s_fu_119_ap_return_1}}, {tmp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_16_6_5_3_0_config2_mult_s_fu_119_ap_return_0}};

assign select_ln323_fu_305_p3 = ((grp_fu_141_p2[0:0] == 1'b1) ? 32'd2 : add_ln323_fu_300_p2);

assign select_ln328_fu_258_p3 = ((icmp_ln289_reg_331[0:0] == 1'b1) ? 32'd2 : add_ln328_fu_253_p2);

assign tmp_7_fu_169_p4 = {{pY_3[31:1]}};

assign tmp_8_fu_185_p4 = {{pX_3[31:1]}};

endmodule //myproject_compute_output_buffer_2d_array_array_ap_fixed_16_6_5_3_0_3u_config2_s
