...
attribute shreg_extract : string;
    ...
    component myproject_sigmoid_array_array_ap_fixed_16_6_5_3_0_1u_sigmoid_config18_s_sigmoid_table_Rsc4 IS
    generic (
        DataWidth : INTEGER;
...
begin
    sigmoid_table_U : component myproject_sigmoid_array_array_ap_fixed_16_6_5_3_0_1u_sigmoid_config18_s_sigmoid_table_Rsc4
    generic map (
        DataWidth => 10,
        AddressRange => 1024,
        AddressWidth => 10)
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif ((not(((layer18_out_TREADY_int_regslice = ap_const_logic_0) or (regslice_both_layer18_out_U_apdone_blk = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, layer16_out_empty_n, ap_CS_fsm_state2, ap_CS_fsm_state3, regslice_both_layer18_out_U_apdone_blk, layer18_out_TREADY_int_regslice)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and (layer18_out_TREADY_int_regslice = ap_const_logic_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state3;
                else
                    ap_NS_fsm <= ap_ST_fsm_state2;
                end if;
            when ap_ST_fsm_state3 => 
                if ((not(((layer18_out_TREADY_int_regslice = ap_const_logic_0) or (regslice_both_layer18_out_U_apdone_blk = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state3;
                end if;
    ...
    ap_ST_fsm_state2_blk_assign_proc : process(layer18_out_TREADY_int_regslice)
    begin
    ...
    ap_ST_fsm_state3_blk_assign_proc : process(regslice_both_layer18_out_U_apdone_blk, layer18_out_TREADY_int_regslice)
    begin
    ...
    ap_done_assign_proc : process(ap_done_reg, ap_CS_fsm_state3, regslice_both_layer18_out_U_apdone_blk, layer18_out_TREADY_int_regslice)
    begin
        if ((not(((layer18_out_TREADY_int_regslice = ap_const_logic_0) or (regslice_both_layer18_out_U_apdone_blk = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state3, regslice_both_layer18_out_U_apdone_blk, layer18_out_TREADY_int_regslice)
    begin
        if ((not(((layer18_out_TREADY_int_regslice = ap_const_logic_0) or (regslice_both_layer18_out_U_apdone_blk = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    layer18_out_TVALID_int_regslice_assign_proc : process(ap_CS_fsm_state2, layer18_out_TREADY_int_regslice)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (layer18_out_TREADY_int_regslice = ap_const_logic_1))) then 
    ...
    sigmoid_table_ce0_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, layer16_out_empty_n)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (layer16_out_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_1_fu_98_p4 <= layer16_out_dout(15 downto 4);
    ...
    zext_ln96_fu_234_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(index_1_fu_226_p3),64));
end behav;
