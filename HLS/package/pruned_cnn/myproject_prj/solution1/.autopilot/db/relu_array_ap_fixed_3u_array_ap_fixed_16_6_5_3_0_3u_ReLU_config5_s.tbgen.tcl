set moduleName relu_array_ap_fixed_3u_array_ap_fixed_16_6_5_3_0_3u_ReLU_config5_s
set isTopModule 0
...
set C_modelName {relu<array<ap_fixed,3u>,array<ap_fixed<16,6,5,3,0>,3u>,ReLU_config5>}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "relu_array_ap_fixed_3u_array_ap_fixed_16_6_5_3_0_3u_ReLU_config5_s",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "layer5_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "104", "DependentChanType" : "0",
				"BlockSignal" : [
...
set ArgLastReadFirstWriteLatency {
	relu_array_ap_fixed_3u_array_ap_fixed_16_6_5_3_0_3u_ReLU_config5_s {
...
set Spec2ImplPortList { 
	...
	layer5_out { ap_fifo {  { layer5_out_din fifo_port_we 1 48 }  { layer5_out_num_data_valid fifo_status_num_data_valid 0 8 }  { layer5_out_fifo_cap fifo_update 0 8 }  { layer5_out_full_n fifo_status 0 1 }  { layer5_out_write fifo_data 1 1 } } }
}
set moduleName relu_array_ap_fixed_3u_array_ap_fixed_16_6_5_3_0_3u_ReLU_config5_s
set isTopModule 0
set isCombinational 0
