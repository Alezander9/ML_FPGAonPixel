...
entity myproject_fifo_w32_d48_A is
    generic (
...
architecture arch of myproject_fifo_w32_d48_A is

    -- component
    component myproject_fifo_w32_d48_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_myproject_fifo_w32_d48_A_ram : myproject_fifo_w32_d48_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity myproject_fifo_w32_d48_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 32;
        ADDR_WIDTH  : integer := 6;
...
architecture arch of myproject_fifo_w32_d48_A_ram is
