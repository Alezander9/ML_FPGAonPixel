...
unsigned int ap_apatb_y_profile_input_cap_bc;
static AESL_RUNTIME_BC __xlx_y_profile_input_V_size_Reader("../tv/stream_size/stream_size_in_y_profile_input.dat");
unsigned int ap_apatb_y0_input_cap_bc;
static AESL_RUNTIME_BC __xlx_y0_input_V_size_Reader("../tv/stream_size/stream_size_in_y0_input.dat");
...
extern "C" void myproject(__cosim_s2__*, __cosim_s2__*, __cosim_s2__*);
extern "C" void apatb_myproject_hw(volatile void * __xlx_apatb_param_y_profile_input, volatile void * __xlx_apatb_param_y0_input, volatile void * __xlx_apatb_param_layer18_out) {
using hls::sim::createStream;
auto* sy_profile_input = createStream((hls::stream<__cosim_s2__>*)__xlx_apatb_param_y_profile_input);
auto* sy0_input = createStream((hls::stream<__cosim_s2__>*)__xlx_apatb_param_y0_input);
  //Create input buffer for layer18_out
  ap_apatb_layer18_out_cap_bc = __xlx_layer18_out_V_size_Reader.read_size();
  __cosim_s2__* __xlx_layer18_out_input_buffer= new __cosim_s2__[ap_apatb_layer18_out_cap_bc];
auto* slayer18_out = createStream((hls::stream<__cosim_s2__>*)__xlx_apatb_param_layer18_out);
  // DUT call
  myproject(sy_profile_input->data<__cosim_s2__>(), sy0_input->data<__cosim_s2__>(), slayer18_out->data<__cosim_s2__>());
sy_profile_input->transfer((hls::stream<__cosim_s2__>*)__xlx_apatb_param_y_profile_input);
sy0_input->transfer((hls::stream<__cosim_s2__>*)__xlx_apatb_param_y0_input);
slayer18_out->transfer((hls::stream<__cosim_s2__>*)__xlx_apatb_param_layer18_out);
}
