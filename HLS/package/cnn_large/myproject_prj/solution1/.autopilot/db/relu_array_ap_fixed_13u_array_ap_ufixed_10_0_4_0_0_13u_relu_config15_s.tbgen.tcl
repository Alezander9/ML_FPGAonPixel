set moduleName relu_array_ap_fixed_13u_array_ap_ufixed_10_0_4_0_0_13u_relu_config15_s
set isTopModule 0
...
set C_modelName {relu<array<ap_fixed,13u>,array<ap_ufixed<10,0,4,0,0>,13u>,relu_config15>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer13_out int 208 regular {fifo 0 volatile }  }
	{ layer15_out int 130 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "layer13_out", "interface" : "fifo", "bitwidth" : 208, "direction" : "READONLY"} , 
 	{ "Name" : "layer15_out", "interface" : "fifo", "bitwidth" : 130, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer13_out_dout sc_in sc_lv 208 signal 0 } 
	...
	{ layer15_out_din sc_out sc_lv 130 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer13_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":208, "type": "signal", "bundle":{"name": "layer13_out", "role": "dout" }} , 
 	...
 	{ "name": "layer15_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":130, "type": "signal", "bundle":{"name": "layer15_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	layer13_out { ap_fifo {  { layer13_out_dout fifo_port_we 0 208 }  { layer13_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer13_out_fifo_cap fifo_update 0 2 }  { layer13_out_empty_n fifo_status 0 1 }  { layer13_out_read fifo_data 1 1 } } }
	layer15_out { ap_fifo {  { layer15_out_din fifo_port_we 1 130 }  { layer15_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer15_out_fifo_cap fifo_update 0 2 }  { layer15_out_full_n fifo_status 0 1 }  { layer15_out_write fifo_data 1 1 } } }
}
