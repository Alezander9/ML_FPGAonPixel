set moduleName sigmoid_array_array_ap_fixed_16_6_5_3_0_1u_sigmoid_config18_s
set isTopModule 0
...
set C_modelName {sigmoid<array,array<ap_fixed<16,6,5,3,0>,1u>,sigmoid_config18>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer16_out int 16 regular {fifo 0 volatile }  }
	{ layer18_out int 16 regular {axi_s 1 volatile  { layer18_out Data } }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "layer16_out", "interface" : "fifo", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer16_out_dout sc_in sc_lv 16 signal 0 } 
	...
	{ layer18_out_TDATA sc_out sc_lv 16 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer16_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "layer16_out", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_layer18_out_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	layer16_out { ap_fifo {  { layer16_out_dout fifo_port_we 0 16 }  { layer16_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer16_out_fifo_cap fifo_update 0 2 }  { layer16_out_empty_n fifo_status 0 1 }  { layer16_out_read fifo_data 1 1 } } }
