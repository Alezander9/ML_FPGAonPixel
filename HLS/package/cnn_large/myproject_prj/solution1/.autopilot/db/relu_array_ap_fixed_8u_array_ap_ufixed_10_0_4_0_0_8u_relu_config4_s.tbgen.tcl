set moduleName relu_array_ap_fixed_8u_array_ap_ufixed_10_0_4_0_0_8u_relu_config4_s
set isTopModule 0
...
set C_modelName {relu<array<ap_fixed,8u>,array<ap_ufixed<10,0,4,0,0>,8u>,relu_config4>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer2_out int 128 regular {fifo 0 volatile }  }
	{ layer4_out int 80 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "layer2_out", "interface" : "fifo", "bitwidth" : 128, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer2_out_dout sc_in sc_lv 128 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer2_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "layer2_out", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	layer2_out { ap_fifo {  { layer2_out_dout fifo_port_we 0 128 }  { layer2_out_num_data_valid fifo_status_num_data_valid 0 8 }  { layer2_out_fifo_cap fifo_update 0 8 }  { layer2_out_empty_n fifo_status 0 1 }  { layer2_out_read fifo_data 1 1 } } }
	layer4_out { ap_fifo {  { layer4_out_din fifo_port_we 1 80 }  { layer4_out_num_data_valid fifo_status_num_data_valid 0 8 }  { layer4_out_fifo_cap fifo_update 0 8 }  { layer4_out_full_n fifo_status 0 1 }  { layer4_out_write fifo_data 1 1 } } }
}
