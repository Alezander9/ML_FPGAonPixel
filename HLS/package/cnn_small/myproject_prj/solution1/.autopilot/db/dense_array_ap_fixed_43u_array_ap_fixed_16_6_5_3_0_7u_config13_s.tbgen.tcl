set moduleName dense_array_ap_fixed_43u_array_ap_fixed_16_6_5_3_0_7u_config13_s
set isTopModule 0
...
set C_modelName {dense<array<ap_fixed,43u>,array<ap_fixed<16,6,5,3,0>,7u>,config13>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer12_out int 688 regular {fifo 0 volatile }  }
	{ layer13_out int 112 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "layer12_out", "interface" : "fifo", "bitwidth" : 688, "direction" : "READONLY"} , 
 	{ "Name" : "layer13_out", "interface" : "fifo", "bitwidth" : 112, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer12_out_dout sc_in sc_lv 688 signal 0 } 
	...
	{ layer13_out_din sc_out sc_lv 112 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer12_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":688, "type": "signal", "bundle":{"name": "layer12_out", "role": "dout" }} , 
 	...
 	{ "name": "layer13_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":112, "type": "signal", "bundle":{"name": "layer13_out", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "301", "EstimateLatencyMax" : "302",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.w13_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_43_6_16_1_1_U160", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_16s_9s_22_1_1_U161", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_7_3_15_1_1_U162", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	layer12_out { ap_fifo {  { layer12_out_dout fifo_port_we 0 688 }  { layer12_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer12_out_fifo_cap fifo_update 0 2 }  { layer12_out_empty_n fifo_status 0 1 }  { layer12_out_read fifo_data 1 1 } } }
	layer13_out { ap_fifo {  { layer13_out_din fifo_port_we 1 112 }  { layer13_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer13_out_fifo_cap fifo_update 0 2 }  { layer13_out_full_n fifo_status 0 1 }  { layer13_out_write fifo_data 1 1 } } }
}
