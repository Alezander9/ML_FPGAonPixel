...
#define WRAPC_STREAM_SIZE_IN_y_profile_input "../tv/stream_size/stream_size_in_y_profile_input.dat"
#define WRAPC_STREAM_INGRESS_STATUS_y_profile_input "../tv/stream_size/stream_ingress_status_y_profile_input.dat"
#define AUTOTB_TVIN_y0_input "../tv/cdatafile/c.myproject.autotvin_y0_input.dat"
#define WRAPC_STREAM_SIZE_IN_y0_input "../tv/stream_size/stream_size_in_y0_input.dat"
#define WRAPC_STREAM_INGRESS_STATUS_y0_input "../tv/stream_size/stream_ingress_status_y0_input.dat"
...
extern "C"
void myproject_hw_stub_wrapper(void*, void*, void*);

extern "C"
void apatb_myproject_hw(void* __xlx_apatb_param_y_profile_input, void* __xlx_apatb_param_y0_input, void* __xlx_apatb_param_layer18_out)
{
  static hls::sim::Stream<hls::sim::Byte<2>> port0 {
    .width = 16,
    .name = "y_profile_input",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_y_profile_input),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_y_profile_input),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_y_profile_input),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_y_profile_input),
#endif
  };
  port0.param = (hls::stream<hls::sim::Byte<2>>*)__xlx_apatb_param_y_profile_input;
  ...
  static hls::sim::Stream<hls::sim::Byte<2>> port1 {
    ...
    .name = "y0_input",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_y0_input),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_y0_input),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_y0_input),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_y0_input),
#endif
  };
  port1.param = (hls::stream<hls::sim::Byte<2>>*)__xlx_apatb_param_y0_input;
  ...
  port2.param = (hls::stream<hls::sim::Byte<2>>*)__xlx_apatb_param_layer18_out;
  port2.hasWrite = true;
  ...
  try {
    ...
    myproject_hw_stub_wrapper(__xlx_apatb_param_y_profile_input, __xlx_apatb_param_y0_input, __xlx_apatb_param_layer18_out);
    port2.buffer();
