...
wire   [0:0] ap_phi_mux_do_init_phi_fu_116_p6;
...
reg   [9:0] data_4_rewind_reg_143;
reg   [9:0] data_3_rewind_reg_157;
reg   [9:0] data_2_rewind_reg_171;
reg   [9:0] data_1_rewind_reg_185;
reg   [9:0] data_6_rewind_reg_199;
reg   [9:0] data_5_rewind_reg_213;
reg   [9:0] p_rewind_reg_227;
reg   [14:0] res4_reg_241;
wire   [2:0] in_index_fu_344_p2;
reg   [2:0] in_index_reg_493;
wire  signed [14:0] x_fu_475_p2;
reg    ap_block_state1;
reg    ap_block_pp0_stage0_subdone;
reg   [2:0] ap_phi_mux_in_index3_phi_fu_132_p6;
reg   [9:0] ap_phi_mux_data_4_phi_phi_fu_259_p4;
reg   [9:0] ap_phi_mux_data_3_phi_phi_fu_271_p4;
reg   [9:0] ap_phi_mux_data_2_phi_phi_fu_283_p4;
reg   [9:0] ap_phi_mux_data_1_phi_phi_fu_295_p4;
reg   [9:0] ap_phi_mux_data_6_phi_phi_fu_307_p4;
reg   [9:0] ap_phi_mux_data_5_phi_phi_fu_319_p4;
reg   [9:0] ap_phi_mux_p_phi_phi_fu_331_p4;
wire   [9:0] ap_phi_reg_pp0_iter1_data_4_phi_reg_255;
wire   [9:0] ap_phi_reg_pp0_iter1_data_3_phi_reg_267;
wire   [9:0] ap_phi_reg_pp0_iter1_data_2_phi_reg_279;
wire   [9:0] ap_phi_reg_pp0_iter1_data_1_phi_reg_291;
wire   [9:0] ap_phi_reg_pp0_iter1_data_6_phi_reg_303;
wire   [9:0] ap_phi_reg_pp0_iter1_data_5_phi_reg_315;
wire   [9:0] data_fu_356_p1;
wire   [9:0] ap_phi_reg_pp0_iter1_p_phi_reg_327;
wire   [63:0] zext_ln42_fu_339_p1;
reg    ap_block_pp0_stage0_01001;
wire   [9:0] a_fu_427_p9;
wire   [9:0] mul_ln73_fu_455_p1;
wire   [19:0] mul_ln73_fu_455_p2;
wire   [12:0] trunc_ln_fu_461_p4;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln42_reg_498 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln42_reg_498 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        do_init_reg_112 <= 1'd0;
    end else if ((((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln42_reg_498 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | (~((real_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1)))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln42_reg_498 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    ...
    end else if ((do_init_reg_112 == 1'd1)) begin
        ap_phi_mux_data_1_phi_phi_fu_295_p4 = {{layer15_out_dout[19:10]}};
    end else begin
...
always @ (*) begin
    if ((ap_phi_mux_do_init_phi_fu_116_p6 == 1'd0)) begin
        ...
        ap_phi_mux_data_2_phi_phi_fu_283_p4 = {{layer15_out_dout[29:20]}};
    end else begin
...
always @ (*) begin
    if ((ap_phi_mux_do_init_phi_fu_116_p6 == 1'd0)) begin
        ...
        ap_phi_mux_data_3_phi_phi_fu_271_p4 = {{layer15_out_dout[39:30]}};
    end else begin
...
always @ (*) begin
    if ((ap_phi_mux_do_init_phi_fu_116_p6 == 1'd0)) begin
        ...
        ap_phi_mux_data_4_phi_phi_fu_259_p4 = {{layer15_out_dout[49:40]}};
    end else begin
...
always @ (*) begin
    if ((ap_phi_mux_do_init_phi_fu_116_p6 == 1'd0)) begin
        ...
        ap_phi_mux_data_5_phi_phi_fu_319_p4 = {{layer15_out_dout[59:50]}};
    end else begin
...
always @ (*) begin
    if ((ap_phi_mux_do_init_phi_fu_116_p6 == 1'd0)) begin
        ...
        ap_phi_mux_data_6_phi_phi_fu_307_p4 = {{layer15_out_dout[69:60]}};
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_95)) begin
        if ((icmp_ln42_reg_498 == 1'd1)) begin
            ap_phi_mux_in_index3_phi_fu_132_p6 = 3'd0;
        end else if ((icmp_ln42_reg_498 == 1'd0)) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (do_init_reg_112 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (do_init_reg_112 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln42_reg_498 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (((icmp_ln42_reg_498 == 1'd1) & (layer16_out_full_n == 1'b0)) | ((do_init_reg_112 == 1'd1) & (layer15_out_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (((icmp_ln42_reg_498 == 1'd1) & (layer16_out_full_n == 1'b0)) | ((do_init_reg_112 == 1'd1) & (layer15_out_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (((icmp_ln42_reg_498 == 1'd1) & (layer16_out_full_n == 1'b0)) | ((do_init_reg_112 == 1'd1) & (layer15_out_empty_n == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter1 = (((icmp_ln42_reg_498 == 1'd1) & (layer16_out_full_n == 1'b0)) | ((do_init_reg_112 == 1'd1) & (layer15_out_empty_n == 1'b0)));
end

always @ (*) begin
    ap_condition_95 = ((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0));
end
...
assign ap_phi_mux_do_init_phi_fu_116_p6 = do_init_reg_112;

assign ap_phi_reg_pp0_iter1_data_1_phi_reg_291 = 'bx;

assign ap_phi_reg_pp0_iter1_data_2_phi_reg_279 = 'bx;

assign ap_phi_reg_pp0_iter1_data_3_phi_reg_267 = 'bx;

assign ap_phi_reg_pp0_iter1_data_4_phi_reg_255 = 'bx;

assign ap_phi_reg_pp0_iter1_data_5_phi_reg_315 = 'bx;

assign ap_phi_reg_pp0_iter1_data_6_phi_reg_303 = 'bx;

assign ap_phi_reg_pp0_iter1_p_phi_reg_327 = 'bx;
...
assign layer16_out_din = $signed(x_fu_475_p2);

assign mul_ln73_fu_455_p1 = mul_ln73_fu_455_p10;

assign mul_ln73_fu_455_p10 = a_fu_427_p9;

assign sext_ln53_fu_471_p1 = $signed(trunc_ln_fu_461_p4);

assign start_out = real_start;

assign trunc_ln_fu_461_p4 = {{mul_ln73_fu_455_p2[19:7]}};

assign w16_address0 = zext_ln42_fu_339_p1;

assign x_fu_475_p2 = ($signed(sext_ln53_fu_471_p1) + $signed(res4_reg_241));
