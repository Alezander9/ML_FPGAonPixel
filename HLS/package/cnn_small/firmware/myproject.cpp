...
void myproject(
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<weight6_t, 252>(w6, "w6.txt");
        nnet::load_weights_from_txt<bias6_t, 7>(b6, "b6.txt");
        nnet::load_weights_from_txt<weight13_t, 301>(w13, "w13.txt");
        nnet::load_weights_from_txt<bias13_t, 7>(b13, "b13.txt");
        nnet::load_weights_from_txt<weight16_t, 7>(w16, "w16.txt");
    ...
    nnet::relu<layer2_t, layer4_t, relu_config4>(layer2_out, layer4_out); // q_activation_3
    ...
    nnet::relu<layer6_t, layer8_t, relu_config8>(layer6_out, layer8_out); // q_activation_4
    ...
    nnet::relu<layer13_t, layer15_t, relu_config15>(layer13_out, layer15_out); // q_activation_5
